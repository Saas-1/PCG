...
Mat MainWindow::equalImageHistHSV(Mat image)
{
...
void MainWindow::setUpImagesAndHistograms()
{
    ...
    imwrite("modified_images\\hist.jpg",histImage2);
    ...
    imwrite("modified_images\\hist_equalized_image.jpg",hist_equalized_image);
        imwrite("modified_images\\hist_equalizedRGB_image.jpg",hist_equalized_image);
    ...
    ui->label_5->setPixmap(QPixmap("modified_images\\hist.jpg").scaled(200,200));
    ...
    //  Эквилизация HSV
    ui->label_19->setPixmap(QPixmap("modified_images\\linImage.jpg").scaled(200,200));
    ui->label_20->setPixmap(QPixmap("modified_images\\hist.jpg").scaled(200,200));

    // Поэдементные операции
